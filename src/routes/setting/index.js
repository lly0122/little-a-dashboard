      ...
      <div className={styles.container}>
        <Row>
          <Col span={24}>
            ...
            <Tag color="#d80b0b" className={classnames(styles.tags, { [styles.tagActive]: sidebarBgColor === 'red' || false })} onClick={() => this.handleSettingColor('red')}></Tag>
            <Tag color="#000" className={classnames(styles.tags, { [styles.tagActive]: sidebarBgColor === 'black' || false })} onClick={() => this.handleSettingColor('black')}></Tag>
            <Tag color="#ff9800" className={classnames(styles.tags, { [styles.tagActive]: sidebarBgColor === 'yellow' || false })} onClick={() => this.handleSettingColor('yellow')}></Tag>
            <Tag color="#1e90ff" className={classnames(styles.tags, { [styles.tagActive]: sidebarBgColor === 'blue' || false })} onClick={() => this.handleSettingColor('blue')}></Tag>
          </Col>
          <Col span={32}>
